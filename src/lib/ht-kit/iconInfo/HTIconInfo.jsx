...
import './HTIconInfo.scss';

const HTIconInfo = ({ onClick, active }) => (
  <svg
    className={`ht-icon-info ${active ? 'active' : ''}`}
    xmlns="http://www.w3.org/2000/svg"
    width="32"
    height="32"
    onClick={onClick}
  >
    <g transform="translate(-1059 -168)">
      <g transform="translate(1059 168)" strokeWidth="1">
        <circle cx="16" cy="16" r="16" stroke="none" />
        <circle cx="16" cy="16" r="15.5" fill="none" />
      </g>
      <g transform="translate(1070 174)">
        <path
